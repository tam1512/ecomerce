    ...
    <ul class="list-unstyled menu-categories" id="accordionExample">
      ...
      <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="categories" data-parent="#accordionExample">
          <li>
            <a href="index.php?tab=categories"> Index </a>
          </li>
          <li>
            <a href="index.php?tab=create_category"> Create </a>
          </li>
        </ul>
      </li>

      <li class="menu">
        <a href="#genres" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
          <div class="">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout">
              <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
              <line x1="3" y1="9" x2="21" y2="9"></line>
        ...
        <ul class="collapse submenu list-unstyled" id="genres" data-parent="#accordionExample">
          <li>
            <a href="index.php?tab=genres"> Index </a>
          </li>
          <li>
            <a href="index.php?tab=create_genre"> Create </a>
          </li>
        </ul>
      </li>
      ...
      <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="products" data-parent="#accordionExample">
          <li>
            <a href="index.php?tab=products"> Index </a>
          </li>
          <li>
            <a href="index.php?tab=create_product"> Create </a>
          </li>
        </ul>
      </li>
      ...
      <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="orders" data-parent="#accordionExample">
          <li>
            <a href="index.php?tab=orders"> Index </a>
          </li>
          <li>
            <a href="index.php?tab=approved"> Approved </a>
          </li>
        </ul>
      </li>

      <li class="menu">
        <a href="#reckon" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
          <div class="">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout">
              <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
              <line x1="3" y1="9" x2="21" y2="9"></line>
        ...
        <ul class="collapse submenu list-unstyled" id="reckon" data-parent="#accordionExample">
          <li>
            <a href="index.php?tab=reckon"> Index </a>
          </li>
        </ul>
      </li>
