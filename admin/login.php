...
<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST')
  {
    ...
    $errorLogin = $loginController->store($adminEmail, $adminPassword);
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Login | E-Commerce - Group 12 </title>
    <link rel="icon" type="image/x-icon" href="assets/img/favicon.ico" />
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="public/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="public/assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="public/assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
...
<body class="form">
                            ...
                            <div class="form">
                                ...
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control"
                                        placeholder="ecommerce@group12.com">
                                </div>
    ...
    <script src="public/assets/js/authentication/form-2.js"></script>
